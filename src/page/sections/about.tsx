const About = () => {
  return (
    <section id="about" className="scroll-mt-24 w-full text-white">
      <div className="w-full px-6 md:px-10 lg:px-16 py-15 text-[#020618]">
        <div className="flex flex-col items-center text-center lg:gap-8 gap-5">
          ...
          <p className="text-[12px] sm:text-[16px] lg:text-[18px leading-relaxed max-w-3xl">
            Full Stack Developer with completed training in{" "}
            <span className="text-[#020618] font-bold">
              React Frontend Development
            </span>
            and{" "}
            <span className="text-[#020618] font-bold">Backend Development</span>.
          ...
          <p className="text-[12px] sm:text-[16px] lg:text-[18px] text-[#020618] leading-relaxed max-w-3xl">
